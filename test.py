...
def graph():
    ...
    st.write("For the purpose of enhanced accessibility, we leverage charts on this page to represent our data about people's condition according to their genders. This approach enables users to efficiently identify and grasp the information most relevant to their needs. .")    
    options = ["Sleep Duration", "Sleep Quality", "Daily Steps"]
    selected_option = st.radio("You can select the information which you would like to see here ", options, horizontal=True)
